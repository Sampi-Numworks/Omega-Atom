...
const AtomDef atomsdefs[ATOM_NUMS] = {
  ...
  { 28,  9,  3, TRANSITION_METAL        , I18n::Message::AtomName_Nickel       , "Ni"  ,  30, 58.6934     , 1.91  },
  { 29, 10,  3, TRANSITION_METAL        , I18n::Message::AtomName_Copper       , "Cu"  ,  34, 63.546      , 1.9   },
  { 30, 11,  3, POST_TRANSITION_METAL   , I18n::Message::AtomName_Zinc         , "Zn"  ,  34, 65.409      , 1.65  },
  { 31, 12,  3, POST_TRANSITION_METAL   , I18n::Message::AtomName_Gallium      , "Ga"  ,  38, 69.723      , 1.81  },
  ...
  { 38,  1,  4, ALKALI_EARTH_METAL      , I18n::Message::AtomName_Strontium    , "Sr"  ,  50, 87.62       , 0.95  },
  { 39,  2,  4, TRANSITION_METAL        , I18n::Message::AtomName_Yttrium      , "Y"   ,  50, 88.90584    , 1.22  },
  { 40,  3,  4, TRANSITION_METAL        , I18n::Message::AtomName_Zirconium    , "Zr"  ,  50, 91.224      , 1.33  },
  { 41,  4,  4, TRANSITION_METAL        , I18n::Message::AtomName_Niobium      , "Nb"  ,  52, 92.90637    , 1.6   },
  { 42,  5,  4, TRANSITION_METAL        , I18n::Message::AtomName_Molybdenum   , "Mo"  ,  56, 95.95       , 2.16  },
  { 43,  6,  4, TRANSITION_METAL        , I18n::Message::AtomName_Technetium   , "Tc"  ,  55, 98          , 1.9   },
  { 44,  7,  4, TRANSITION_METAL        , I18n::Message::AtomName_Ruthemium    , "Ru"  ,  58, 101.07      , 2.2   },
  { 45,  8,  4, TRANSITION_METAL        , I18n::Message::AtomName_Rhodium      , "Rh"  ,  58, 102.90550   , 2.28  },
  { 46,  9,  4, TRANSITION_METAL        , I18n::Message::AtomName_Palladium    , "Pd"  ,  60, 106.42      , 2.20  },
  { 47, 10,  4, TRANSITION_METAL        , I18n::Message::AtomName_Silver       , "Ag"  ,  60, 107.8682    , 1.93  },
  { 48, 11,  4, POST_TRANSITION_METAL   , I18n::Message::AtomName_Cadmium      , "Cd"  ,  66, 112.414     , 1.69  },
  { 49, 12,  4, POST_TRANSITION_METAL   , I18n::Message::AtomName_Indium       , "In"  ,  66, 114.818     , 1.78  },
  { 50, 13,  4, POST_TRANSITION_METAL   , I18n::Message::AtomName_Tin          , "Sn"  ,  70, 118.710     , 1.96  },
  { 51, 14,  4, METALLOID               , I18n::Message::AtomName_Antimony     , "Sb"  ,  70, 121.760     , 2.05  },
  { 52, 15,  4, METALLOID               , I18n::Message::AtomName_Tellurium    , "Te"  ,  78, 127.60      , 2.1   },
  { 53, 16,  4, HALOGEN                 , I18n::Message::AtomName_Indine       , "I"   ,  74, 126.90447   , 2.66  },
  { 54, 17,  4, NOBLE_GAS               , I18n::Message::AtomName_Xenon        , "Xe"  ,  78, 131.293     , 2.60  },
  
  
  { 55,  0,  5, ALKALI_METAL            , I18n::Message::AtomName_Caesium      , "Cs"  ,  78, 132.90545196, 0.79  },
  { 56,  1,  5, ALKALI_EARTH_METAL      , I18n::Message::AtomName_Barium       , "Ba"  ,  82, 137.327     , 0.89  },
  ...
  { 60,  6,  7, LANTHANIDE              , I18n::Message::AtomName_Neodymium    , "Nd"  ,  82, 144.242     , 1.14  },
  { 61,  7,  7, LANTHANIDE              , I18n::Message::AtomName_Promethium   , "Pm"  ,  84, 145         , 1.13  },
  { 62,  8,  7, LANTHANIDE              , I18n::Message::AtomName_Samarium     , "Sm"  ,  90, 150.36      , 1.17  },
  { 63,  9,  7, LANTHANIDE              , I18n::Message::AtomName_Europium     , "Eu"  ,  90, 151.964     , 1.12  },
  { 64, 10,  7, LANTHANIDE              , I18n::Message::AtomName_Gadolinium   , "Gd"  ,  94, 157.25      , 1.20  },
  { 65, 11,  7, LANTHANIDE              , I18n::Message::AtomName_Terbium      , "Tb"  ,  94, 158.92534   , 1.20  },
  { 66, 12,  7, LANTHANIDE              , I18n::Message::AtomName_Dyxprosium   , "Dy"  ,  98, 162.500     , 1.22  },
  { 67, 13,  7, LANTHANIDE              , I18n::Message::AtomName_Holmium      , "Ho"  ,  98, 164.93033   , 1.23  },
  { 68, 14,  7, LANTHANIDE              , I18n::Message::AtomName_Erbium       , "Er"  ,  98, 167.259     , 1.24  },
  { 69, 15,  7, LANTHANIDE              , I18n::Message::AtomName_Thulium      , "Tm"  , 100, 168.93422   , 1.25  },
  { 70, 16,  7, LANTHANIDE              , I18n::Message::AtomName_Ytterbium    , "Yb"  , 104, 173.04      , 1.1   },
  { 71, 17,  7, LANTHANIDE              , I18n::Message::AtomName_Lutetium     , "Lu"  , 104, 174.9668    , 1.27  },

  { 72,  3,  5, TRANSITION_METAL        , I18n::Message::AtomName_Hafnium      , "Hf"  , 108, 178.49      , 1.3   },
  ...
  { 75,  6,  5, TRANSITION_METAL        , I18n::Message::AtomName_Rhenium      , "Re"  , 112, 186.207     , 1.9   },
  { 76,  7,  5, TRANSITION_METAL        , I18n::Message::AtomName_Osmium       , "Os"  , 116, 190.23      , 2.2   },
  { 77,  8,  5, TRANSITION_METAL        , I18n::Message::AtomName_Iridium      , "Ir"  , 116, 192.217     , 2.2   },
  ...
  { 80, 11,  5, POST_TRANSITION_METAL   , I18n::Message::AtomName_Mercury      , "Hg"  , 122, 200.59      , 2     },
  { 81, 12,  5, POST_TRANSITION_METAL   , I18n::Message::AtomName_Thalium      , "Tl"  , 124, 204.3833    , 1.62  },
  { 82, 13,  5, POST_TRANSITION_METAL   , I18n::Message::AtomName_Lead         , "Pb"  , 126, 207.2       , 2.33  },
  { 83, 14,  5, POST_TRANSITION_METAL   , I18n::Message::AtomName_Bismuth      , "Bi"  , 126, 208.98040   , 2.02  },
  { 84, 15,  5, POST_TRANSITION_METAL   , I18n::Message::AtomName_Polonium     , "Po"  , 126, 209         , 2.0   },
  { 85, 16,  5, METALLOID               , I18n::Message::AtomName_Astatine     , "At"  , 125, 210         , 2.2   },
  ...
  {103, 17,  8, ACTINIDE                , I18n::Message::AtomName_Lawrencium   , "Lr"  , 163, 266         , 1.3   },

  {104,  3,  6, TRANSITION_METAL        , I18n::Message::AtomName_Rutherfordium, "Rf"  , 163, 267         , -1    },
  {105,  4,  6, TRANSITION_METAL        , I18n::Message::AtomName_Dubnium      , "Db"  , 163, 268         , -1    },
  {106,  5,  6, TRANSITION_METAL        , I18n::Message::AtomName_Seaborgium   , "Sg"  , 163, 269         , -1    },
  ...
  {114, 13,  6, UNKNOWN                 , I18n::Message::AtomName_Flerovium    , "Fl"  , 175, 289         , -1    },
  {115, 14,  6, UNKNOWN                 , I18n::Message::AtomName_Moscovium    , "Mv"  , 174, 289         , -1    },
  {116, 15,  6, UNKNOWN                 , I18n::Message::AtomName_Livermorium  , "Lv"  , 177, 293         , -1    },
  {117, 16,  6, UNKNOWN                 , I18n::Message::AtomName_Tennessine   , "Ts"  , 177, 294         , -1    },
  {118, 17,  6, NOBLE_GAS               , I18n::Message::AtomName_Oganesson    , "Og"  , 176, 294         , -1    },
